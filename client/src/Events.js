...
export default function Videoadded() {
    return (
        <div className='w-[100%] '>
            <div className='flex justify-evenly xsm:block'>
            <div className="flex-col h-[400px] border-2 w-[390px] shadow-xl rounded-lg mb-5 hover:scale-95 transition duration-100 ease-in xsm:h-auto xsm:w-[100%]">
                <div className=""><img className="rounded-t w-[350px] m-auto h-48 " src="img1.png" alt="" /></div>
