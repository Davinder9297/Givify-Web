        ...
        <div className='w-[100%] '>
            ...
            <div className="flex-col h-[400px] border-2 w-[390px] shadow-xl rounded-lg mb-5 hover:scale-95 transition duration-100 ease-in xsm:h-auto">
                ...
                <div className="flex justify-between">
                    <div className="bg-yellow-500 px-1 mt-1 text-xs py-1 rounded-tr rounded-br text-white">Event Name</div>
                    <div className="bg-amber-900 mt-1 text-xs px-1 py-1 rounded-tl rounded-bl text-white">Date</div>
                </div>
                ...
                <div><button className='mt-1 py-1 w-[90%] bg-red-700 rounded-md hover:bg-red-600 hover:text-white'>Donate Now</button></div>
            </div>
